...
var $author$project$Main$GotFpMsg = function (a) {
	return {$: 'GotFpMsg', a: a};
};
...
var $author$project$Main$GotRpMsg = function (a) {
	return {$: 'GotRpMsg', a: a};
};
...
var $author$project$ForgotPassword$Initial = {$: 'Initial'};
var $author$project$ForgotPassword$initialModel = {formState: $author$project$ForgotPassword$Initial, storeEmail: ''};
var $author$project$ForgotPassword$init = function (_v0) {
	return _Utils_Tuple2($author$project$ForgotPassword$initialModel, $elm$core$Platform$Cmd$none);
};
...
var $author$project$ResetPassword$Initial = {$: 'Initial'};
var $author$project$ResetPassword$initialModel = {formState: $author$project$ResetPassword$Initial, resetCodeParam: '', storeConfirmPassword: '', storePassword: ''};
...
var $author$project$ResetPassword$init = function (resetCodeParam) {
	var cleanedResetCode = A3($elm$core$String$replace, '/password-reset/', '', resetCodeParam);
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$ResetPassword$initialModel,
			{resetCodeParam: cleanedResetCode}),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$initCurrentPage = function (_v0) {
	...
	switch (_v1.$) {
		...
		case 'ForgotPasswordPage':
			var _v5 = $author$project$ForgotPassword$init(_Utils_Tuple0);
			var pageModel = _v5.a;
			var pageCmds = _v5.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						page: $author$project$Main$ForgotPasswordPage(pageModel)
					}),
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2($elm$core$Platform$Cmd$map, $author$project$Main$GotFpMsg, pageCmds),
							existingCmds
						])));
		case 'ResetPasswordPage':
			var _v6 = $author$project$ResetPassword$init(url.path);
			var pageModel = _v6.a;
			var pageCmds = _v6.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						page: $author$project$Main$ResetPasswordPage(pageModel)
					}),
				A2($elm$core$Platform$Cmd$map, $author$project$Main$GotRpMsg, pageCmds));
		case 'VerificationPage':
			var _v7 = A2($author$project$Verification$init, model.session, url.path);
			var pageModel = _v7.a;
			var pageCmds = _v7.b;
			return _Utils_Tuple2(
				_Utils_update(
		...
		default:
			var _v8 = $author$project$Profile$init(model.session);
			var pageModel = _v8.a;
			var pageCmds = _v8.b;
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Credentials$ResetCodeParam = function (a) {
	return {$: 'ResetCodeParam', a: a};
};
...
var $author$project$Credentials$passwordCodeStringParser = A2(
	$elm$url$Url$Parser$custom,
	'RESETCODEPARAM',
	function (resetPassword) {
		return A2(
			$elm$core$Maybe$map,
			$author$project$Credentials$ResetCodeParam,
...
var $author$project$Main$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('password-reset'),
				$author$project$Credentials$passwordCodeStringParser))
		]));
		...
		if (_v0.$ === 'Just') {
			switch (_v0.a.$) {
				...
				case 'ResetPassword':
					return _Utils_eq(
						$author$project$Credentials$fromSessionToToken(session),
						$elm$core$Maybe$Nothing) ? $author$project$Main$ResetPasswordPage(
						$author$project$ResetPassword$init(url.path).a) : $author$project$Main$NotFoundPage;
				case 'ForgotPassword':
					var _v3 = _v0.a;
					return _Utils_eq(
						$author$project$Credentials$fromSessionToToken(session),
						$elm$core$Maybe$Nothing) ? $author$project$Main$ForgotPasswordPage(
						$author$project$ForgotPassword$init(_Utils_Tuple0).a) : $author$project$Main$NotFoundPage;
				case 'Home':
					var _v4 = _v0.a;
...
var $author$project$ForgotPassword$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$ForgotPassword$HideError = {$: 'HideError'};
var $author$project$ForgotPassword$Loading = {$: 'Loading'};
var $author$project$ForgotPassword$Success = {$: 'Success'};
...
var $author$project$User$ConstructEmail = F3(
	function (beforeEt, afterEt, afterDot) {
		return {afterDot: afterDot, afterEt: afterEt, beforeEt: beforeEt};
	});
var $author$project$User$AfterDot = function (a) {
	return {$: 'AfterDot', a: a};
};
...
var $author$project$User$afterDotParser = A2(
	$elm$parser$Parser$keeper,
	$elm$parser$Parser$succeed($author$project$User$AfterDot),
	A2(
		$elm$parser$Parser$andThen,
		function (afterDot) {
			return $elm$core$String$isEmpty(afterDot) ? $elm$parser$Parser$problem('Invalid email') : $elm$parser$Parser$succeed(afterDot);
		},
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompWhile($elm$core$Char$isAlphaNum))));
var $author$project$User$AfterEt = function (a) {
	return {$: 'AfterEt', a: a};
};
var $elm$core$Debug$log = _Debug_log;
var $author$project$User$afterEtParser = A2(
	$elm$parser$Parser$keeper,
	$elm$parser$Parser$succeed($author$project$User$AfterEt),
	A2(
		$elm$parser$Parser$andThen,
		function (afterEt) {
			var _v0 = A2($elm$core$Debug$log, 'afterEt', afterEt);
			return $elm$core$String$isEmpty(afterEt) ? $elm$parser$Parser$problem('Invalid email') : $elm$parser$Parser$succeed(afterEt);
		},
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompWhile($elm$core$Char$isAlphaNum))));
var $author$project$User$BeforeEt = function (a) {
	return {$: 'BeforeEt', a: a};
};
var $author$project$User$beforeEtParser = A2(
	$elm$parser$Parser$keeper,
	$elm$parser$Parser$succeed($author$project$User$BeforeEt),
	A2(
		$elm$parser$Parser$andThen,
		function (beforeEt) {
			return $elm$core$String$isEmpty(beforeEt) ? $elm$parser$Parser$problem('Invalid email') : $elm$parser$Parser$succeed(beforeEt);
		},
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompWhile($elm$core$Char$isAlphaNum))));
...
var $author$project$User$emailParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			...
			$elm$parser$Parser$succeed(
				F3(
					function (a, b, c) {
						...
						if (((_v0.a.$ === 'BeforeEt') && (_v0.b.$ === 'AfterEt')) && (_v0.c.$ === 'AfterDot')) {
							var be = _v0.a.a;
							var ae = _v0.b.a;
							var ad = _v0.c.a;
							return $elm$core$Maybe$Just(
								A3($author$project$User$ConstructEmail, be, ae, ad));
						} else {
							return $elm$core$Maybe$Nothing;
						}
					})),
			A2(
				...
				$author$project$User$beforeEtParser,
				$elm$parser$Parser$symbol('@'))),
		A2(
			$elm$parser$Parser$ignorer,
			$author$project$User$afterEtParser,
			$elm$parser$Parser$symbol('.'))),
	$author$project$User$afterDotParser);
...
var $author$project$User$parseEmail = function (email) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$User$emailParser, email);
	if (_v0.$ === 'Err') {
		return $elm$core$Result$Err('Invalid email');
	} else {
		return $elm$core$Result$Ok(
			$author$project$User$Email(email));
	}
};
var $elm$core$String$trim = _String_trim;
var $author$project$User$fromStringToValidEmail = function (email) {
	var trimmedEmail = $elm$core$String$trim(email);
	return $elm$core$String$isEmpty(trimmedEmail) ? $elm$core$Result$Err('Email can\'t be empty') : $author$project$User$parseEmail(trimmedEmail);
};
var $author$project$ForgotPassword$Done = function (a) {
	return {$: 'Done', a: a};
};
...
var $author$project$User$emailEncoder = function (email) {
...
var $author$project$ForgotPassword$submitForgotPassword = function (email) {
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'email',
							$author$project$User$emailEncoder(email))
						]))),
			expect: $elm$http$Http$expectWhatever($author$project$ForgotPassword$Done),
			url: '/api/forgot-password'
		});
};
var $author$project$ForgotPassword$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Submit':
				var validatedCred = $author$project$User$fromStringToValidEmail(model.storeEmail);
				if (validatedCred.$ === 'Err') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								formState: $author$project$ForgotPassword$Error(error)
							}),
						A2(
							$elm$core$Task$perform,
							function (_v2) {
								return $author$project$ForgotPassword$HideError;
							},
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{formState: $author$project$ForgotPassword$Loading}),
						$author$project$ForgotPassword$submitForgotPassword(validCredentials));
				}
			case 'HideError':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{formState: $author$project$ForgotPassword$Initial}),
					$elm$core$Platform$Cmd$none);
			case 'StoreEmail':
				var str = msg.a;
				return _Utils_Tuple2(
			...
			default:
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{formState: $author$project$ForgotPassword$Success, storeEmail: ''}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								formState: $author$project$ForgotPassword$Error(
...
var $author$project$User$passwordEncoder = function (password) {
	return $elm$json$Json$Encode$string(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'password',
				$author$project$User$passwordEncoder(password))
			]));
};
...
var $author$project$ResetPassword$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$ResetPassword$HideError = {$: 'HideError'};
var $author$project$ResetPassword$Loading = {$: 'Loading'};
var $author$project$ResetPassword$Success = {$: 'Success'};
var $author$project$ResetPassword$Done = function (a) {
	return {$: 'Done', a: a};
};
var $author$project$ResetPassword$submitResetPassword = F2(
	function (password, resetCodeParam) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					$elm$json$Json$Encode$object(
				...
				expect: $elm$http$Http$expectWhatever($author$project$ResetPassword$Done),
...
var $author$project$User$andThenValidateConfirmPassword = F2(
	function (confirmPassword, resultCredential) {
		return A2(
			$elm$core$Result$andThen,
			function (cred) {
				var validPassword = $author$project$User$fromPasswordToString(cred.password);
...
var $author$project$User$validateConfirmPassword = function (_v0) {
	var password = _v0.password;
...
var $author$project$ResetPassword$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Submit':
				var validatedCred = $author$project$User$validateConfirmPassword(
					{confirmPassword: model.storeConfirmPassword, password: model.storePassword});
				if (validatedCred.$ === 'Err') {
					var error = validatedCred.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								formState: $author$project$ResetPassword$Error(error)
							}),
						A2(
							$elm$core$Task$perform,
							function (_v2) {
								return $author$project$ResetPassword$HideError;
							},
							$elm$core$Process$sleep(4000)));
				} else {
					var password = validatedCred.a.password;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{formState: $author$project$ResetPassword$Loading}),
						A2($author$project$ResetPassword$submitResetPassword, password, model.resetCodeParam));
				}
			case 'HideError':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{formState: $author$project$ResetPassword$Initial}),
					$elm$core$Platform$Cmd$none);
			case 'StorePassword':
				var str = msg.a;
				return _Utils_Tuple2(
			...
			default:
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{formState: $author$project$ResetPassword$Success, storeConfirmPassword: '', storePassword: ''}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								formState: $author$project$ResetPassword$Error(
									$author$project$Helpers$buildErrorMessage(err))
							}),
						A2(
							$elm$core$Task$perform,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotRpMsg':
				var rpMsg = msg.a;
				var _v10 = model.page;
				if (_v10.$ === 'ResetPasswordPage') {
					var rpModel = _v10.a;
					var _v11 = A2($author$project$ResetPassword$update, rpMsg, rpModel);
					var rpModelFromRp = _v11.a;
					var rpMsgFromRp = _v11.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$ResetPasswordPage(rpModelFromRp)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$GotRpMsg, rpMsgFromRp));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'GotFpMsg':
				var fpMsg = msg.a;
				var _v12 = model.page;
				if (_v12.$ === 'ForgotPasswordPage') {
					var fpModel = _v12.a;
					var _v13 = A2($author$project$ForgotPassword$update, fpMsg, fpModel);
					var modelFromFp = _v13.a;
					var msgFromFp = _v13.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$ForgotPasswordPage(modelFromFp)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$GotFpMsg, msgFromFp));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'GotSignupMsg':
				...
				var _v14 = model.page;
				if (_v14.$ === 'SignupPage') {
					var signupModel = _v14.a;
					var _v15 = A2($author$project$Signup$update, signupMsg, signupModel);
					var signupModelFromSignup = _v15.a;
					var signupMsgFromSignup = _v15.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'GotSubscriptionChangeMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{session: session}),
					function () {
						var _v16 = $author$project$Credentials$fromSessionToToken(session);
						if (_v16.$ === 'Just') {
							var token = _v16.a;
							var _v17 = A2(
								$simonh1000$elm_jwt$Jwt$decodeToken,
...
var $author$project$ForgotPassword$StoreEmail = function (a) {
	return {$: 'StoreEmail', a: a};
};
var $author$project$ForgotPassword$Submit = {$: 'Submit'};
...
var $author$project$ForgotPassword$view = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('Submitted successfully !')
										])),
									A2(
									$rtfeldman$elm_css$Html$Styled$p,
									_List_Nil,
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('Check your email for rest link.')
										]))
								]));
				}
			}(),
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Enter your email and we will send you a reset link.')
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$ForgotPassword$StoreEmail),
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$ForgotPassword$Submit)
							]),
						_List_fromArray(
							[
...
var $author$project$ResetPassword$StoreConfirmPassword = function (a) {
	return {$: 'StoreConfirmPassword', a: a};
};
var $author$project$ResetPassword$StorePassword = function (a) {
	return {$: 'StorePassword', a: a};
};
var $author$project$ResetPassword$Submit = {$: 'Submit'};
var $author$project$ResetPassword$view = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Reset password')
					])),
				function () {
				var _v0 = model.formState;
				switch (_v0.$) {
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('All done !')
										])),
									A2(
									$rtfeldman$elm_css$Html$Styled$p,
									_List_Nil,
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('Your password has been reset. Please login with your new password.')
										]))
								]));
				}
			}(),
					...
					[
							...
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$GlobalStyles$inputStyle),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('password'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$ResetPassword$StorePassword),
										$rtfeldman$elm_css$Html$Styled$Attributes$value(model.storePassword)
									]),
								_List_Nil)
							])),
							...
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$GlobalStyles$inputStyle),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('password'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$ResetPassword$StoreConfirmPassword),
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$GlobalStyles$buttonStyle),
								$rtfeldman$elm_css$Html$Styled$Attributes$type_('button'),
								$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$ResetPassword$Submit)
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Submit')
			...
			[
				...
				switch (_v0.$) {
					...
					case 'ForgotPasswordPage':
						...
						return A2(
							$rtfeldman$elm_css$Html$Styled$map,
							$author$project$Main$GotFpMsg,
							$author$project$ForgotPassword$view(fpModal));
					case 'ResetPasswordPage':
						var rPasswordModel = _v0.a;
						return A2(
							$rtfeldman$elm_css$Html$Styled$map,
							$author$project$Main$GotRpMsg,
							$author$project$ResetPassword$view(rPasswordModel));
					case 'HomePage':
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ClickedLink":["Browser.UrlRequest"],"ChangedUrl":["Url.Url"],"GotSignupMsg":["Signup.Msg"],"GotLoginMsg":["Login.Msg"],"GotProfileMsg":["Profile.Msg"],"GotFpMsg":["ForgotPassword.Msg"],"GotRpMsg":["ResetPassword.Msg"],"GotHomeMsg":["Home.Msg"],"GotVerificationMsg":["Verification.Msg"],"GotSubscriptionChangeMsg":["Credentials.Session"],"GetLogout":[],"OpenDropdown":[],"GotTime":["Time.Posix"],"CheckSessionExpired":["( Credentials.Session, Maybe.Maybe Time.Posix )"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"ForgotPassword.Msg":{"args":[],"tags":{"StoreEmail":["String.String"],"Submit":[],"HideError":[],"Done":["Result.Result Http.Error ()"]}},"Home.Msg":{"args":[],"tags":{"NoOp":[]}},"Login.Msg":{"args":[],"tags":{"StoreEmail":["String.String"],"StorePassword":["String.String"],"LoginSubmit":[],"LoginDone":["Result.Result Http.Error Credentials.Token"],"HideError":[]}},"Profile.Msg":{"args":[],"tags":{"StoreFirstName":["String.String"],"ProfileSubmit":["Credentials.Session"],"ProfileDone":["Result.Result Http.Error Credentials.Token"],"FileRequest":[],"FileRequestProceed":["File.File"],"FileRead":["Result.Result Http.Error String.String"]}},"ResetPassword.Msg":{"args":[],"tags":{"StorePassword":["String.String"],"StoreConfirmPassword":["String.String"],"Submit":[],"HideError":[],"Done":["Result.Result Http.Error ()"]}},"Signup.Msg":{"args":[],"tags":{"StoreEmail":["String.String"],"StorePassword":["String.String"],"StoreConfirmPassword":["String.String"],"SignupSubmit":[],"SignupDone":["Result.Result Http.Error Credentials.Token"],"HideError":[]}},"Verification.Msg":{"args":[],"tags":{"VerifyApiCallStart":["Credentials.Session"],"VerifyDone":["Result.Result Http.Error Credentials.Token"],"TokenToLS":["Credentials.Token"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Credentials.Session":{"args":[],"tags":{"LoggedIn":["Credentials.Token"],"Guest":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"File.File":{"args":[],"tags":{"File":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Credentials.Token":{"args":[],"tags":{"Token":["String.String"]}}}}})}});}(this));